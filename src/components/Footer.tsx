    ...
    <footer className="bg-blue-900 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">LIDER REFRIGERAÇÃO</h3>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-blue-200">
              <div className="flex items-center gap-2"><Phone size={16} /> (11) 99999-9999</div>
              <div className="flex items-center gap-2"><Mail size={16} /> contato@liderefrigeracao.com.br</div>
              <div className="flex items-center gap-2"><MapPin size={16} /> Av. Industrial, 1000 - Setor de Transportes</div>
            </div>
          </div>
        ...
        <div className="border-t border-blue-800 pt-6 text-center text-xs text-blue-400">
          © {new Date().getFullYear()} Lider Refrigeração. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
