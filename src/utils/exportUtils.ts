...
// Função interna para construir o documento PDF (compartilhada entre download e share)
...
export const getServiceOrderFile = (order: any, settings?: any): File | null => {
  ...
  return new File([pdfBlob], `Orcamento_${order.id}.pdf`, { type: 'application/pdf' });
};